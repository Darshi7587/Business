    ...
    <>
      ...
      >
        ...
        <motion.button
          ...
          className="absolute -right-3 top-24 w-6 h-6 rounded-full bg-gray-900 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-indigo-500 hover:bg-indigo-500/20 transition-all shadow-lg"
        >
